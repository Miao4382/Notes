...
*** ~get()~
This function accepts an url, and will return the response object, you can hold the response object using a variable. This object contains data got from the API, and some attributes indicating the status of the response object. For example:
#+begin_src python -n
