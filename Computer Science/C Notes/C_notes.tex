...
\section{Generals}
\label{sec:org624eb77}
\subsection{Some Facts}
\label{sec:org981b338}
...
\label{sec:org8500eff}
p64

\texttt{+, -, *, /, \%, <<, >>, \&, \textasciicircum{}, |}
\subsection{Symbolic Constants}
\label{sec:orgc3e9000}
...
\label{sec:org88b6e0f}
\subsection{External Variables}
\label{sec:orgb38d8ff}
...
\label{sec:org1505e79}
\subsubsection{File Inclusion}
\label{sec:org0f48b75}
\subsubsection{Macro Substitution}
\label{sec:org3de925a}
\paragraph{General}
\label{sec:org7d2569c}
...
\label{sec:org8ee012e}
\section{Pointers and Arrays}
\label{sec:org1bbced9}
\subsection{Command-line Arguments}
\label{sec:orgab1a90b}
p128 in CPL.
...
\subsubsection{Example: \texttt{miniPrintf()} \label{orgb4fa0f4}}
\label{sec:orgfd265c2}
...
\label{sec:org275e49f}
p171.

\subsubsection{A simple example}
\label{sec:org6798829}
...
\subsection{File Access\label{orgdf97252}}
\label{sec:org055f147}
\subsubsection{Opening a file}
\label{sec:orgf3a78d5}
...
\label{sec:org948e8f7}
\subsubsection{Storage Management}
\label{sec:orgeb88d63}
...
\label{sec:orgcc37e21}
\subsection{File Descriptors}
\label{sec:org199cefe}
...
If you want to work with other files, you have to explicitly open other files in order to read or write them. In section \hyperref[orgdf97252]{File Access}, we mentioned a way of operating files by routines defined in \texttt{<stdio.h>}. Here, we introduce low-level system calls to do this.
...
\label{sec:org215aded}
\paragraph{Generals}
\label{sec:org1b3b24f}
...
\label{sec:org20cc465}
\paragraph{Generals}
\label{sec:org78a7694}
...
This is similar with the simple \texttt{printf()} function we built \hyperref[orgb4fa0f4]{earlier}. It is a function with variable-length argument lists. To process this kind of function, we \texttt{\#include <stdarg.h>}, and the header is:
\begin{minted}[breaklines=true,breakanywhere=true]{c}
...
\label{sec:org258002c}


\section{Place Holder}
\label{sec:orge9cc302}
\end{document}
