...
\section{104. Maximum Depth of Binary Tree \label{org9605041}}
\label{sec:orge013d0c}
\subsection{Problem Statement}
\label{sec:org6a2ab5f}
...
\subsection{Problem Statement}
\label{sec:orga71aa5f}
\href{https://leetcode.com/problems/balanced-binary-tree/}{Link}
\subsection{Analysis}
\label{sec:org841942b}
\subsubsection{Recursion}
\label{sec:orgd38dae6}
...
\subsection{Solution}
\label{sec:org99bd76d}
\subsubsection{C++}
\label{sec:org39800f6}
\paragraph{recursion}
\label{sec:org6597086}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
/**
 * Definition for a binary tree node.
 * struct TreeNode {
...
\subsection{Solution}
\label{sec:orgf50ed53}
\subsubsection{C++}
\label{sec:org6864b8a}
\paragraph{recursion}
\label{sec:org4a94da4}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
/**
 * Definition for a binary tree node.
 * struct TreeNode {
...
\label{sec:orgabc1504}
\subsection{Problem Statement}
\label{sec:orgb812414}
\href{https://leetcode.com/problems/path-sum/}{Link}
\subsection{Analysis}
\label{sec:org7b89400}
\subsubsection{Recursion}
\label{sec:org2d79bc7}
...
\subsection{Solution}
\label{sec:orgfbb7f16}
\subsubsection{C++}
\label{sec:org5257fc2}
\paragraph{recursion (88\%, 92\%)}
\label{sec:org63c55f1}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
/**
 * Definition for a binary tree node.
 * struct TreeNode {
...
\label{sec:org6119197}
\subsection{Problem Statement}
\label{sec:org6e144a4}
\href{https://leetcode.com/problems/path-sum-ii/}{Link}
\subsection{Analysis}
\label{sec:org4ea65f6}
\subsubsection{DFS}
\label{sec:orgf1b20ed}
...
\subsection{Solution}
\label{sec:orgb550987}
\subsubsection{C++}
\label{sec:orge9c0285}
\paragraph{DFS (80\%, 40\%)}
\label{sec:orge1664b6}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
/**
 * Definition for a binary tree node.
 * struct TreeNode {
...
\subsection{Solution}
\label{sec:org0b39523}
\subsubsection{C++}
\label{sec:org643de8b}
\paragraph{brutal force}
\label{sec:org2dd7df2}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\label{sec:org3a7df65}
\subsection{Problem Statement}
\label{sec:org21e720f}
\href{https://leetcode.com/problems/single-number/}{Link
}
\subsection{Analysis}
\label{sec:org8148bec}
\subsubsection{Hash Table}
\label{sec:org4d3587b}
...
\subsection{Solution}
\label{sec:orgd3ea176}
\subsubsection{C++}
\label{sec:org2259d0f}
\paragraph{hash table I: time (16.06\%) space (15.74\%)}
\label{sec:org1f98837}
\begin{minted}[linenos,firstnumber=1,breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\label{sec:org3bc427b}
\subsection{Solution}
\label{sec:org850269d}
\subsubsection{C++}
\label{sec:orgd84699b}
\paragraph{brutal force}
\label{sec:orgf6dc474}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
/**
...
\end{itemize}
\section{167. Two Sum II - Input array is sorted  \label{org0ed3772}}
\label{sec:org8718286}
\subsection{Problem Statement}
...
\label{sec:org1267aae}
\subsection{Problem Statement}
\label{sec:org3d6586a}
\href{https://leetcode.com/problems/valid-anagram/}{Link}
\subsection{Analysis}
\label{sec:org48982bf}
\subsubsection{Sort}
\label{sec:orga43f9d9}
\subsubsection{Hash Table}
\label{sec:org20f0eb9}
\subsection{Solution}
\label{sec:org0259e88}
\subsection{todos [/]}
\label{sec:orga884604}
\begin{itemize}
...
\label{sec:org17227e1}
\subsection{Problem Statement}
\label{sec:org7b9af65}
\subsection{Analysis}
\label{sec:org89555f3}
\subsubsection{math}
\label{sec:org29d4b68}
...
\subsection{Solution}
\label{sec:org1354b57}
\subsubsection{C++}
\label{sec:orgf9ee3a6}
\paragraph{math: time \(O(N)\), space \(O(1)\)}
\label{sec:org57e5e31}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\item[{$\square$}] generalize this problem
\end{itemize}
\section{283. Move Zeros \label{org97258c4}}
\label{sec:org8dd500a}
\subsection{Problem Statement}
\label{sec:org4059765}
\href{https://leetcode.com/problems/move-zeroes/}{Link}
\subsection{Analysis}
\label{sec:org4ce0747}
...
\subsection{Solution}
\label{sec:org2ff6b15}
\subsubsection{C++}
\label{sec:orgcdcf38d}
\paragraph{bubble sort. time (5\%) space (75\%)}
\label{sec:org7cb5385}
...
\subsection{todos [1/2]}
\label{sec:orgcec1cd4}
\begin{itemize}
\item[{$\boxtimes$}] write down your own solution
\item[{$\square$}] check discussion page
\end{itemize}
\section{389. Find the Difference \label{org32e67a7}}
\label{sec:org07e4b53}
\subsection{Problem Statement}
\label{sec:org0cb57ae}
\href{https://leetcode.com/problems/find-the-difference/}{Link}
\subsection{Analysis}
\label{sec:orga0cc3a7}
\subsubsection{Sort}
\label{sec:org9698cee}
...
\subsection{Solution}
\label{sec:orgfcd26cc}
\subsubsection{C++}
\label{sec:org57fd37f}
\paragraph{sort}
\label{sec:org8d58b13}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\item[{$\square$}] generalize the problem
\end{itemize}
\section{461. Hamming Distance \label{org12406d9}}
\label{sec:org696d70d}
\subsection{Problem Statement}
\label{sec:org6880e2e}
\href{https://leetcode.com/problems/hamming-distance/}{Link}
\subsection{Analysis}
\label{sec:orgfb5a8df}
...
\end{Verbatim}
\subsection{Solution}
\label{sec:org8bd4bf9}
\subsubsection{C++}
\label{sec:org5b1bff2}
\paragraph{Time(14.63\%)}
\label{sec:org80092bc}
\begin{minted}[linenos,firstnumber=1,breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\subsection{Solution}
\label{sec:orgb7ffdcf}
\subsubsection{C++}
\label{sec:org4297fe7}
\paragraph{Not Accepted (too slow)}
\label{sec:orge00d6eb}
...
\subsection{Solution}
\label{sec:org0d934a2}
\subsubsection{C++}
\label{sec:orge4bd5b6}
\paragraph{use sorting}
\label{sec:orgf2dcffa}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\end{minted}
\paragraph{Iterative}
\label{sec:org2b7cdec}
\subsection{todos [0/2]}
\label{sec:orge68808b}
\begin{itemize}
...
\subsection{Solution}
\label{sec:orgdfe5ca0}
\subsubsection{Python}
\label{sec:org837968a}
\paragraph{count meta-strings}
\label{sec:org1710b96}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{python}
...
\subsection{Solution}
\label{sec:org2304d11}

\subsubsection{C++}
\label{sec:org0edfb01}

\paragraph{recursion (stupid)}
\label{sec:orgec28ea9}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
...
\label{sec:org02d3c7e}
\subsection{Problem Statement}
\label{sec:org43cbe7f}
\href{https://leetcode.com/problems/remove-outermost-parentheses/}{Link}
\subsection{Analysis}
\label{sec:org0f22931}
\subsubsection{Stack}
\label{sec:orgc54e134}
...
\subsubsection{Two pointers}
\label{sec:org2c26d5a}
\subsection{Solution}
\label{sec:org5bfc8f0}
\subsubsection{C++}
\label{sec:orgcff6fcd}
\paragraph{Stack}
\label{sec:orgbb35c4e}
\begin{minted}[breaklines=true,breakanywhere=true,frame=single,framesep=10pt]{c++}
class Solution {
public:
